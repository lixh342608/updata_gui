...
class tk_Msginput:
    ...
    def tk_input(self):
        ...
        #设置新域名
        lab3=Label(self.root,text="公共设置",font = 'Helvetica -15 bold',bg="#99ffcc").grid(row=6,column=0,padx=3,pady=3)
        ...
        try:
            ...
            mailpw_var.set("") 
        #back_dir_var.set(self.col["backdir"])
        Label(self.root,text="主服务器信息",bg="#99ffcc").grid(row=1,column=0,padx=3,pady=3)
        Label(self.root,text="cake服务器主机信息",bg="#99ffcc").grid(row=3,column=0,padx=3,pady=3)
        Label(self.root,text="主服务器连接密码",bg="#99ffcc").grid(row=1,column=3,padx=3,pady=3)
        Label(self.root,text="cake服务器连接密码",bg="#99ffcc").grid(row=3,column=3,padx=3,pady=3)
        Label(self.root,text="源文件地址",bg="#99ffcc").grid(row=7,column=0,padx=3,pady=3)
        Label(self.root,text="远程地址",bg="#99ffcc").grid(row=2,column=0,padx=3,pady=3)
        Label(self.root,text="cake远程地址",bg="#99ffcc").grid(row=4,column=0,padx=3,pady=3)
        Label(self.root,text="更新序号",bg="#99ffcc").grid(row=7,column=3,padx=3,pady=3)
        Label(self.root,text="用户身份",bg="#99ffcc").grid(row=2,column=3,padx=3,pady=3)
        Label(self.root,text="cake用户身份",bg="#99ffcc").grid(row=4,column=3,padx=3,pady=3)
        Label(self.root,text="请确认更新信息后点击下方开始按钮进行更新操作",bg="#99ffcc").grid(row=8,column=3,columnspan=3,padx=3,pady=3)
        Label(self.root,text="校准值",bg="#99ffcc").grid(row=8,column=0,padx=3,pady=3)
        #Label(self.root,text="备份文件目录",bg="#99ffcc").grid(row=8,column=3)
        Label(self.root,text="邮箱帐户",bg="#99ffcc").grid(row=12,column=0,padx=3,pady=3)
        Label(self.root,text="邮箱密码",bg="#99ffcc").grid(row=12,column=3,padx=3,pady=3)
        for i in range(0,5):
        ...
        #b1_image = Image.open("./image/open.jpg")
            ...
            check_var=IntVar()
            cbut1=Checkbutton(self.root,text="开启配置和邮件功能",variable=check_var,command=set_but,bg="#ffcc00").grid(row=11,column=2,padx=3,pady=3)
